    ...
    <a-collapse-panel key="1" header="个人信息" class="personal-info-panel">
      ...
      >
        ...
        <a-row gutter="24">
          ...
          <a-col :span="12">
            <a-input
              v-model:value="personalInfo.university"
              placeholder="请输入所在大学"
              addonBefore="所在大学"
            />
          </a-col>
        ...
        <a-row gutter="24">
          <a-col :span="12">
            <a-select
              v-model:value="personalInfo.politicalStatus"
              placeholder="请选择政治面貌"
          ...
          <a-col :span="12">
            <a-select
              v-model:value="personalInfo.gender"
              placeholder="请选择性别"
        ...
        <a-row gutter="24">
          <a-col :span="12">
            <a-input
              v-model:value="personalInfo.major"
              placeholder="请输入专业"
              addonBefore="专业"
            />
          </a-col>
          <a-col :span="12">
            <a-input
              v-model:value="personalInfo.age"
              placeholder="请输入年龄"
              addonBefore="年龄"
            />
          </a-col>
        ...
        <a-row gutter="24">
          ...
          <a-col :span="12">
            <!-- 应聘岗位 -->
            <a-input
              v-model:value="personalInfo.applicationPosition"
              placeholder="应聘岗位"
              addonBefore="岗位"
            />
          </a-col>
...
// 这里personalInfo修改时，会穿透到store中，自动修改store中的personalInfo
