      ...
      <a-space direction="vertical" style="width: 100%">
        ...
        <div v-for="(skill, index) in skills" :key="index" class="skill-item">
          ...
          <a-form layout="vertical">
            <AIEnhancePopover
              :description="`是我简历中的技能描述，帮我润色和优化以下内容，使其更加简洁、专业和吸引面试官，
                    你只返回润色后的一段文字，其余什么都不要说，也不要说例如“好的”这种话！！！：\n${skill.skillName}`"
              :extend="`下面这个是我简历中的技能描述，请以分点的方式给出建议，告诉我可以从哪几个方面扩展优化。你只返回你给出的几点建议其余什么都不要说，也不要说例如“好的”这种话！！！：
                    \n${skill.skillName}`"
              @update="(content: string) => skill.skillName = content"
            >
              <a-input
                v-model:value="skill.skillName"
                placeholder="请输入技能名称"
                addonBefore="技能"
              />
            </AIEnhancePopover>
