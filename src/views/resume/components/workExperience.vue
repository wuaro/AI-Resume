      ...
      <a-space direction="vertical" style="width: 100%">
        ...
        >
          ...
          <a-form layout="vertical">
            ...
            <AIEnhancePopover
              :description="`是我简历中的过往工作描述，帮我润色和优化以下内容，使其更加简洁、专业和吸引面试官，
                    你只返回润色后的一段文字，其余什么都不要说，也不要说例如“好的”这种话！！！：\n${work.description}`"
              :extend="`下面这个是我简历中的过往工作描述，请以分点的方式给出建议，告诉我可以从哪几个方面扩展优化。你只返回你给出的几点建议其余什么都不要说，也不要说例如“好的”这种话！！！：
                    \n${work.description}`"
              @update="(content: string) => work.description = content"
            >
              <a-textarea
