        ...
        >
          ...
          <a-form layout="vertical">
            ...
            <a-row gutter="24" style="margin-top: 16px">
              <a-col :span="12">
                <a-date-picker
                  v-model:value="project.startDate"
                  placeholder="开始时间"
                  style="width: 100%"
                  format="YYYY-MM-DD"
            ...
            <!-- 项目简介 -->
            <AIEnhancePopover
              :description="`这是我简历中的项目简介，请帮我润色和优化以下内容，使其更加简洁、专业和吸引面试官，
                    你只返回润色后的一段文字，其余什么都不要说，也不要说例如“好的”这种话！！！：${project.briefIntroduction}`"
              :extend="`下面这个是我简历中的过往项目简介，请以分点的方式给出建议，告诉我可以从哪几个方面扩展优化。你只返回你给出的几点建议其余什么都不要说，也不要说例如“好的”这种话！！！：
                    \n${project.briefIntroduction}`"
              @update="(content: string) => project.briefIntroduction = content"
            >
              <a-textarea
                v-model:value="project.briefIntroduction"
                placeholder="请输入项目简介"
                addon-before="项目简介"
                rows="4"
            ...
            <AIEnhancePopover
              :description="`请帮我润色和优化以下内容，是我简历中的项目要点，
                    使其更加简洁、专业和吸引面试官，
                    你只返回润色后的一段文字，其余什么都不要说，也不要说例如“好的”这种话！！！：\n${project.description}`"
              :extend="`下面这个是我简历中的项目要点，请以分点的方式给出建议，告诉我可以从哪几个方面扩展优化。你只返回你给出的几点建议其余什么都不要说，也不要说例如“好的”这种话！！！：
                    \n${project.description}`"
              @update="(content: string) => project.description = content"
            >
              <a-textarea
