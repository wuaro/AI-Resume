...
const tourSteps: TourProps["steps"] = [
  ...
  },
  {
    ...
    target: () =>
      aiChatRef.value?.$el.querySelector("#ai-choose-content") as HTMLElement,
    placement: "bottom",
  ...
  },
  {
    ...
    target: () =>
      aiChatRef.value?.$el.querySelector("#ai-chat-content") as HTMLElement,
    placement: "top",
    prevButtonProps: { children: () => "上一步" },
    nextButtonProps: { children: () => "下一步" },
  },
  {
    title: "经历修改",
    description:
      "最后：“经历深挖”模式下，AI会自动修改您的经历帮您优化！您只需要给建议即可",
    target: () =>
      inputRef.value?.$el.querySelector("#input-value") as HTMLElement,
    placement: "left",
    prevButtonProps: { children: () => "上一步" },
